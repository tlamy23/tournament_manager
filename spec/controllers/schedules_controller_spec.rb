...
describe SchedulesController do
  ...
  let(:valid_attributes) { { "date" => "2013-07-28" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested schedule" do
        ...
        Schedule.any_instance.should_receive(:update_attributes).with({ "date" => "2013-07-28" })
        put :update, {:id => schedule.to_param, :schedule => { "date" => "2013-07-28" }}, valid_session
      end
